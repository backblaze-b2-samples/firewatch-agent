...
name: spark-user
description: >
  DGX Spark setup and software installation assistant. Use when the user mentions
  DGX Spark, GB10, sm_121, installing/running/deploying software on Spark,
  Spark containers, Spark GPU issues, Spark CUDA, or any app setup on Spark
  (vLLM, ComfyUI, Open WebUI, NIM, RAPIDS, LM Studio).
